...
Public Class Serialisation
    ...
    Private FormatFichier As String = "GridCreator"
    Private Filtre As String = "Fichier " & FormatFichier & " (*." & FormatFichier & ")|*." & FormatFichier
    ...
    Sub New(ByVal FormatFichier As String)
        Me.FormatFichier = FormatFichier
        Me.Filtre = "Fichier " & FormatFichier & " (*." & FormatFichier & ")|*." & FormatFichier
    End Sub
    Sub New(ByVal FormatFichier As String, ByVal CheminDefaut As String)
        Me.FormatFichier = FormatFichier
        Me.Filtre = "Fichier " & FormatFichier & " (*." & FormatFichier & ")|*." & FormatFichier
        Me.Chemin = CheminDefaut
    End Sub
